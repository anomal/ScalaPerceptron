...
class Perceptron {
  ...
  /**
    ...
    * @param decisionUnit decision unit of perceptron to be trained
    ...
    * @return decision unit trained with input data
    */
  ...
  /**
    ...
    */
  private def adjustWeights(weights:Seq[Double], adjustments:Seq[Double]): Try[Seq[Double]] = {
